...
import { activateHomeSection, activateHomeShelf, addHomeCollectionItem, getHomePlaybackState, goToHomeCollection, handleHomeFurnitureWheel, handleHomeVisibilityChange, loadEditorialFeaturedDate, moveHomeCategorySelector, moveHomeFurniture, moveHomeShelf, moveHomeShelfBay, movePlaylistSelection, moveSpotlightSelector, openHomeCollectionDetail, refreshEditorialHome, scrollHomeFurniture, selectHomeCategory, selectHomeShelfEntry, selectPlaylistEntry, selectSpotlight, setCarouselItem, syncHomeFurnitureControls, tickHomeAutoplay } from "../surfaces/home.js";
...
import { changeScannerHistoryMode, changeScannerQueueFilter, clearScannerHistory, handleScannerReviewAction, loadScannerQueue, moveScannerQueueSelection, scannerHistoryMode, searchScannerQueue, selectScannerQueueItem } from "../surfaces/inbox-scanner.js";
      ...
      fields.homeSections.addEventListener("scroll", syncHomeFurnitureControls, { passive: true });
      window.addEventListener("resize", syncHomeFurnitureControls);
      ...
      fields.addLibraryExclusionRule.addEventListener("click", addLibraryExclusionRuleRow);
      fields.libraryExclusionRuleRows.addEventListener("click", handleLibraryExclusionRuleRowClick);
      fields.libraryShareAvailability.addEventListener("change", toggleLibraryShareAvailabilityFields);
      ...
      fields.streamingRegionForm.addEventListener("submit", addStreamingRegion);
      fields.saveStreamingPolicy.addEventListener("click", saveStreamingPolicy);
      fields.streamingRegionList.addEventListener("click", handleStreamingAction);
