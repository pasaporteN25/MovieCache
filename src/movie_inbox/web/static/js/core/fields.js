...
import { scannerQueue } from "../surfaces/inbox-scanner.js";
      ...
      export const fields = {
        ...
        menuInboxBadge: document.querySelector("[data-menu-inbox-badge]"),
        menuScannerBadge: document.querySelector("[data-menu-scanner-badge]"),
        ...
        scopeStrip: document.querySelector("#scopeStrip"),
        scopeStripSummary: document.querySelector("#scopeStripSummary"),
        ...
        scannerMissingIdentityCount: document.querySelector("#scannerMissingIdentityCount"),
        scannerYearTypeConflictCount: document.querySelector("#scannerYearTypeConflictCount"),
        scannerLikelyExistingCount: document.querySelector("#scannerLikelyExistingCount"),
        scannerNoSignalCount: document.querySelector("#scannerNoSignalCount"),
        scannerHistoryCount: document.querySelector("#scannerHistoryCount"),
        persistScannerHistory: document.querySelector("#persistScannerHistory"),
        clearScannerHistory: document.querySelector("#clearScannerHistory"),
        ...
        collectionModeTabs: document.querySelector("#collectionModeTabs"),
        collectionModeKicker: document.querySelector("#collectionModeKicker"),
        collectionModeDescription: document.querySelector("#collectionModeDescription"),
        collectionQueryLabel: document.querySelector("#collectionQueryLabel"),
        collectionAnchor: document.querySelector("#collectionAnchor"),
        collectionAnchorLabel: document.querySelector("#collectionAnchorLabel"),
        collectionAnchorTitle: document.querySelector("#collectionAnchorTitle"),
        collectionAnchorMeta: document.querySelector("#collectionAnchorMeta"),
        ...
        libraryExclusionRuleRows: document.querySelector("#libraryExclusionRuleRows"),
        addLibraryExclusionRule: document.querySelector("#addLibraryExclusionRule"),
        libraryExclusionRulesFeedback: document.querySelector("#libraryExclusionRulesFeedback"),
        libraryShareAvailability: document.querySelector("#libraryShareAvailability"),
        libraryShareAvailabilityFields: document.querySelector("#libraryShareAvailabilityFields"),
        libraryClubTitle: document.querySelector("#libraryClubTitle"),
        libraryClubDescription: document.querySelector("#libraryClubDescription"),
        libraryShareAvailabilityFeedback: document.querySelector("#libraryShareAvailabilityFeedback"),
        ...
        publicPresentationForm: document.querySelector("#publicPresentationForm"),
        publicPresentationCollection: document.querySelector("#publicPresentationCollection"),
        publicPresentationTitle: document.querySelector("#publicPresentationTitle"),
        publicPresentationDescription: document.querySelector("#publicPresentationDescription"),
        previewPublicPresentation: document.querySelector("#previewPublicPresentation"),
        createPublicPresentation: document.querySelector("#createPublicPresentation"),
        publicPresentationFeedback: document.querySelector("#publicPresentationFeedback"),
        publicPresentationPreview: document.querySelector("#publicPresentationPreview"),
        publicPresentationList: document.querySelector("#publicPresentationList"),
        streamingRegionForm: document.querySelector("#streamingRegionForm"),
        streamingRegionCode: document.querySelector("#streamingRegionCode"),
        streamingRegionName: document.querySelector("#streamingRegionName"),
        saveStreamingPolicy: document.querySelector("#saveStreamingPolicy"),
        streamingPolicy: document.querySelector("#streamingPolicy"),
        streamingFeedback: document.querySelector("#streamingFeedback"),
        streamingRegionList: document.querySelector("#streamingRegionList"),
        ...
        detailDrawerTitle: document.querySelector("#detailDrawerTitle"),
        ...
        mergeSurvivorOptions: document.querySelector("#mergeSurvivorOptions"),
