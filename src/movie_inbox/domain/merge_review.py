...
MERGE_FIELDS = (
    ...
    MergeField("duration_minutes", "Duracion (minutos)", "metadata"),
    MergeField("countries", "Paises", "metadata", "list"),
    MergeField("original_languages", "Idiomas originales", "metadata", "list"),
    MergeField("producers", "Produccion", "metadata", "list"),
    MergeField("composers", "Musica", "metadata", "list"),
    ...
    MergeField("mal_id", "MyAnimeList ID", "sources"),
